...
//    switch (index) {
//        case 1:
//            weekday = [CommenMethod localizationString:@"Monday"];
//            break;
//        case 2:
//            weekday = [CommenMethod localizationString:@"Tuesday"];
//            break;
//        case 3:
//            weekday = [CommenMethod localizationString:@"Wednesday"];
//            break;
//        case 4:
//            weekday = [CommenMethod localizationString:@"Thurday"];
//            break;
//        case 5:
//            weekday = [CommenMethod localizationString:@"Friday"];
//            break;
//        case 6:
//            weekday = [CommenMethod localizationString:@"Saturday"];
//            break;
//        case 0:
//            weekday = [CommenMethod localizationString:@"Sunday"];
//            break;
//        default:
//            break;
//    }
