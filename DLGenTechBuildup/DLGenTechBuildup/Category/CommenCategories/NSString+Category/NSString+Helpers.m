...
{
    NSMutableCharacterSet *filterCharSet = [NSMutableCharacterSet characterSetWithCharactersInString:str];
    [filterCharSet formUnionWithCharacterSet:[NSCharacterSet whitespaceCharacterSet]];
    NSMutableString *filtedStr = [NSMutableString stringWithString:[[self componentsSeparatedByCharactersInSet:filterCharSet] componentsJoinedByString:@""]];
    if (b == YES) {
        
         NSString *result = [filtedStr stringByReplacingOccurrencesOfString:@" " withString:@""];
